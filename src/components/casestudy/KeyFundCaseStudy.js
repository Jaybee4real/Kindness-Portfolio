    ...
    <div className={styles.container}>
      <CaseHero
        ...
        meta={[
          ...
          { label: 'Team', value: 'UI/UX Designer, Product Manager, Tech Lead' },
        ]}
      ...
      <ProblemSolution
        problem={{
          ...
          chips: ['Trust Concerns', 'High Costs', 'Limited Financial Knowledge'],
        }}
        solution={{
          ...
          chips: ['Affordable Entry Cost', 'AI Verified Checks', 'Transparency and Trustworthiness'],
        }}
      />
      ...
      <div className={styles.section}>
        <Split label="USER INTERVIEWS">
          <p className={styles.body}>
            My design research centered on understanding how everyday people perceive real
            estate investing — and why so many capable savers never start.
          </p>
        </Split>
        <DesignedFor
          ...
          panel="panelWhite"
          cards={[
            { icon: Icons.briefcase, title: 'Young Professionals', body: 'Salaried earners in their 20s and 30s with some disposable income, eager to grow their money but priced out of property and unsure where to begin.' },
            { icon: Icons.compass, title: 'First-Time Investors', body: 'People who have never invested before and are wary of anything that sounds complex, risky, or "too good to be true."' },
            { icon: Icons.globe, title: 'Diaspora Investors', body: 'Members of the African diaspora who want to invest back home or globally but distrust the verification and fund-management process from a distance.' },
          ]}
        />
        <TakeawaysPanel
          items={[
      ...
      <Split label="USER PERSONA">
        <p className={styles.body}>
          By creating a user persona, I gained insight into the actual users&rsquo; needs,
          ...
          users&rsquo; needs and pain points, based on the user persona that has been created.
        </p>
      </Split>
      <Persona
        name="Chinedu"
      ...
      <div className={styles.section}>
        ...
        <Reveal className={styles.galleryFlex} as="div">
          {[1, 2, 3, 4, 5, 6, 7].map((n) => (
            <img key={n} src={`/images/work/${SLUG}/midfi-${n}.webp`} alt="" style={{ height: 340 }} />
          ))}
        </Reveal>
      </div>
      ...
      <div className={styles.section}>
        <Split label="HIGH-FIDELITY WIREFRAMES">
          <p className={styles.body}>
            With the high-fidelity designs, I translated the structure into a clean, trustworthy
            interface. Because trust was the central challenge, the visual system leans on
            clarity: generous spacing, confident typography, verification badges, and real-time
            data shown openly. Every screen is designed to make a cautious user feel informed and
            in control.
          </p>
        </Split>
        <Reveal className={styles.annRow} as="div">
          <div className={styles.annPhones}>
            <img src={`/images/work/${SLUG}/hifi-1.webp`} alt="" />
            <img src={`/images/work/${SLUG}/hifi-2.webp`} alt="" />
          </div>
          <div className={styles.annText}>
            <div className={styles.annTitle}>Onboarding Screens</div>
            <p className={styles.annDesc}>
              A short, friendly onboarding that explains fractional ownership in seconds and gets
              users to their first opportunity quickly, without overwhelming them.
            </p>
          </div>
        </Reveal>
        <Reveal className={`${styles.annRow} ${styles.annReverse}`} as="div">
          <div className={styles.annPhones}>
            <img src={`/images/work/${SLUG}/hifi-3.webp`} alt="" />
          </div>
          <div className={styles.annText}>
            <div className={styles.annTitle}>Homepage / Dashboard</div>
            <p className={styles.annDesc}>
              The home screen surfaces portfolio value, returns at a glance, and curated, verified
              opportunities, so users see both their progress and their next move.
            </p>
          </div>
        </Reveal>
        <Reveal className={styles.annRow} as="div">
          <div className={styles.annPhones}>
            <img src={`/images/work/${SLUG}/hifi-4.webp`} alt="" />
            <img src={`/images/work/${SLUG}/hifi-5.webp`} alt="" />
            <img src={`/images/work/${SLUG}/hifi-6.webp`} alt="" />
          </div>
          <div className={styles.annText}>
            <div className={styles.annTitle}>Property Detail Screen</div>
            <p className={styles.annDesc}>
              Each listing shows verification status, AI-generated risk and opportunity summaries,
              projected returns, and a transparent fee breakdown, all in plain language.
            </p>
          </div>
        </Reveal>
      </div>
      ...
      <div className={styles.section}>
        ...
        <Reveal className={styles.galleryFlex} as="div" delay={0.05}>
          {Array.from({ length: 10 }).map((_, index) => (
            <img key={index} src={`/images/work/${SLUG}/main-${index + 1}.webp`} alt="" style={{ height: 360 }} />
          ))}
        </Reveal>
        <Reveal as="div">
          <ProtoButton />
      ...
      <KeyTakeaways
        items={[
          { term: 'Designing for trust is a feature', text: 'The biggest lesson from KeyFund was that trust is built by making verification, and fund movement visible at every decision point. Transparency had to be designed into the flow, not added on top.' },
          { term: 'Meeting users where their confidence is', text: 'Cautious, first-time investors need fewer unknowns. Plain-language guidance and AI explanations did more for adoption than any single screen, because they removed the fear that kept people from starting.' },
          { term: 'Accessibility means more than affordability', text: 'Lowering the entry point to $50 opened the door, but real accessibility meant pairing low cost with clarity and education so users could afford to invest and actually understand and trust what they were doing.' },
        ]}
      />
    </div>
  );
