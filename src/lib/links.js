export const LINKS = {
  email: 'mailto:kindness.ukandu@gmail.com',
  behance: 'http://behance.net/caramelkindness',
  x: 'https://x.com/_AmarisKay',
  linkedin: 'https://www.linkedin.com/in/kindness-ukandu-87591022b/',
};
